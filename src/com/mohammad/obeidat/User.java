...
public class User {
	...
	public String validateExpense(int expenseValue) {
		...
		double partSalary = this.currentSalary / 3;
		System.out.print("Part Salary: " + partSalary);
		System.out.print("Expense Value: " + expenseValue);
		...
		if (day >= 1 && day <= 10) {
			...
			if (expenseValue >= (partSalary * 2)) {
				...
				System.out.print("Do You Want To Continuo? \t Y/N: ");
				userChoice = input.nextLine();
			}
		} else if (day >= 10 && day <= 20) {
			if (expenseValue >= (partSalary * 1)) {
				System.out.println(
						"You are about to make a high expense value in the current date, the remaining value of your salary will be: "
								+ (this.currentSalary - expenseValue));
			}
